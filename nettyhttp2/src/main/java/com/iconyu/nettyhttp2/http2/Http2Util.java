package com.iconyu.nettyhttp2.http2;

import com.iconyu.nettyhttp2.http2.client.Http2ClientResponseHandler;
import com.iconyu.nettyhttp2.http2.client.Http2SettingsHandler;
import com.iconyu.nettyhttp2.http2.server.Http2ServerResponseHandler;
...
public class Http2Util {
    ...
    /**
     * As part of this channel's initialization, we're adding an APN handler to the pipeline in a utility method getServerAPNHandler()
     * @return
     */
    ...
    public static ApplicationProtocolNegotiationHandler getClientAPNHandler(int maxContentLength, final Http2SettingsHandler settingsHandler, final Http2ClientResponseHandler responseHandler) {
